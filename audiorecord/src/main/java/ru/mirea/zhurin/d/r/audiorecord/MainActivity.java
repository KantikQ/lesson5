package ru.mirea.zhurin.d.r.audiorecord;
...
import ru.mirea.zhurin.d.r.audiorecord.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void stopRecording() {
        if (mediaRecorder != null) {
            Log.d(TAG, "остановить запись");
            mediaRecorder.stop();
            mediaRecorder.reset();
            mediaRecorder.release();
            Toast.makeText(this, "Вы сейчас не записываетесь!", Toast.LENGTH_SHORT).show();
        }
    }

    private void processAudioFile() {
        Log.d(TAG, "обработать аудиофайл");
